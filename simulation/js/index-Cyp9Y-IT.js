  ...
  wO = ({ onStepChange: e }) => {
    const [t, n] = b.useState(0),
      ...
      l = [
        ...
        {
          text: "Select an option below to reveal a command. Use 'user@gmail.com' as the username and the revealed command as the password to observe its effect on the login behavior.",
          type: "question",
          options: [
            "-- (Double Dash)",
            "/* (Comment Start)",
        ...
        {
          text: "Select an option below to reveal a command. Use 'user@gmail.com' as the username and the revealed command as the password to try an SQL injection attack.",
          type: "question",
